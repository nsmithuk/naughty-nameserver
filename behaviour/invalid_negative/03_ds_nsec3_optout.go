...
type NoOptoutDSNsec3RecordDeligation struct{}

func (r *NoOptoutDSNsec3RecordDeligation) Setup(ns *naughty.Nameserver) []*naughty.Zone {

	name := dns.Fqdn(fmt.Sprintf("missing-deligation-optout-nsec3.%s", ns.BaseZoneName))
